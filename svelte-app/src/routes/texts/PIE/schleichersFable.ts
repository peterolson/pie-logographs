...
export const schleichersFable = {
	...
	gloss: `
        ...
        sheep it wool not have , it horses see .  
        one heavy wagon carried ;  
        one big load ;
        one man quickly carried .  
        sheep horses spoke :
        " man see horses and drive , heart my upset . "  
        horses now spoke :
        " listen , sheep !
        this see , us upset heart :
        man , master , self sheep wool warm garment make ,
        sheep now wool not have . "
        this heard , sheep field fled .
        `,
