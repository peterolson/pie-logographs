...
export const anittaText = {
	...
	NOW AT OVERCOME onts dat sg DEICTIC TRULY GOOD us m nom sg BE _ira sec 3 sg , URU:ne-e-sa-|as gen sg BEGET us s nom sg URU:ku-us-sa-ra-|as gen sg BEGET us s dat sg ... .  
	BEGET us s nom sg URU:ku-us-sa-ra gen sg TOIL r yo_s abl sg NEARBY teh2 nom THICK ros m ins pl AWAY_GO _ira sec 3 sg ,  
	NOW URU:ne-e-sa-|an acc sg NIGHTTIME o_nts dat sg ATTAIN es ins sg GIVE _ira active sec 3 sg .  
